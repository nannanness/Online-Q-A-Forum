...
public class IndexCountDaoImpl implements IIndexCountDao {
...
//    @Override
//    public List<Problem_Replay> getIndexContentByLike(String like, String like1) throws SQLException {
//        String likeSql = "%"+like+"%";
//        String likeSql1 = "%"+like1+"%";
//        String sql = "select p.problemId ,title,content,user_Img,user_Name,problemType, replayContent, replayUserId,remarkCount\n" +
//                "                from (select *from replay r,userinfo u where r.replayUserId=u.user_Id)\n" +
//                "\t\t\t\trc ,problem p WHERE p.problemId=rc.problemId AND (title LIKE ? OR title Like ? ) LIMIT 0,10 ;";
